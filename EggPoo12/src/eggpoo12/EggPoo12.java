...
public class EggPoo12 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(person1.getFechaNacimiento().getDate());
        
        System.out.println("La edad de la persona es : " + person1.calcularEdad());
        System.out.println("La persona es menor a 35 años? " + person1.menorQue(35));
